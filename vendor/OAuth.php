...
class OAuthRequest
{
    ...
    public static function from_request($http_method = NULL, $http_url = NULL, $parameters = NULL) {
        ...
        if (!$parameters) {
            ...
            if ($http_method == "POST" && isset($request_headers['Content-Type'])
                && strstr($request_headers['Content-Type'], 'application/x-www-form-urlencoded')) {

                $post_data = OAuthUtil::parse_parameters(
                    trim(file_get_contents(self::$POST_INPUT), '&'));
...
class OAuthServer
{
    ...
    private function get_token($request, $consumer, $token_type = "access") {
        $token_field = $request instanceof OAuthRequest ? $request->get_parameter('oauth_token')
            : NULL;
    ...
    private function check_signature($request, $consumer, $token) {
        ...
        $timestamp = $request instanceof OAuthRequest ? $request->get_parameter('oauth_timestamp')
            : NULL;
